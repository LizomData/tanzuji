...
public class RC4Util {
    ...
    private static String keyde="lz.2004.11.14";
    public static String addS="|SDF&Y897234jlsdjfu!*";
    ...
    public static String encryRC4String(String data) throws UnsupportedEncodingException {
        if (data == null ) {
            return null;
        }
        return bytesToHex(encryRC4Byte(data+addS, keyde, "UTF-8"));
    }
    ...
    public static String decryRC4(String data) throws UnsupportedEncodingException {
        if (data == null ) {
            return null;
        }
        return new String(RC4Base(hexToByte(data), keyde),"UTF-8");
    }
